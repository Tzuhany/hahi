...
pub enum LoopControl {
    ...
    Return(crate::core::r#loop::TurnStopReason),
}
    ...
    pub fn into_loop_control(self) -> LoopControl {
        match self {
            ...
            RecoveryAction::StopDiminishingReturns => {
                LoopControl::Return(crate::core::r#loop::TurnStopReason::DiminishingReturns)
            }
            RecoveryAction::Abort { reason } => {
                LoopControl::Return(crate::core::r#loop::TurnStopReason::Error(reason))
            }
        }
    }
}
