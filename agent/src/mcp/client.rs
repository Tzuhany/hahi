...
//
// Note: The entire MCP subsystem is wired into service.rs once MCP server
// configs are read from the agent config. Dead code warnings are expected
...
impl McpClient {
    ...
    /// Whether tools from this server bypass deferral.
