...
/// Score a tool against search keywords.
///
/// Scoring weights (higher = better match):
///   - Exact name match:     10 points per keyword
///   - Name contains:         5 points per keyword
///   - Search hint match:     4 points per keyword
///   - Description contains:  2 points per keyword
