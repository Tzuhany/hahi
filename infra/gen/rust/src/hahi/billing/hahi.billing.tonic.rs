        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/hahi.billing.BillingService/CheckQuota",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("hahi.billing.BillingService", "CheckQuota"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn deduct_usage(
            &mut self,
            request: impl tonic::IntoRequest<super::DeductUsageRequest>,
        ) -> std::result::Result<
            tonic::Response<super::DeductUsageResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/hahi.billing.BillingService/DeductUsage",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("hahi.billing.BillingService", "DeductUsage"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/hahi.billing.BillingService/GetUsage",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("hahi.billing.BillingService", "GetUsage"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod billing_service_server {
    ...
    pub trait BillingService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn deduct_usage(
            &self,
            request: tonic::Request<super::DeductUsageRequest>,
        ) -> std::result::Result<
            tonic::Response<super::DeductUsageResponse>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/hahi.billing.BillingService/CheckQuota" => {
                    ...
                    struct CheckQuotaSvc<T: BillingService>(pub Arc<T>);
                    impl<
                        T: BillingService,
                    ...
                    for CheckQuotaSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as BillingService>::check_quota(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/hahi.billing.BillingService/DeductUsage" => {
                    #[allow(non_camel_case_types)]
                    struct DeductUsageSvc<T: BillingService>(pub Arc<T>);
                    impl<
                        T: BillingService,
                    > tonic::server::UnaryService<super::DeductUsageRequest>
                    for DeductUsageSvc<T> {
                        type Response = super::DeductUsageResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as BillingService>::deduct_usage(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = DeductUsageSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/hahi.billing.BillingService/GetUsage" => {
                    #[allow(non_camel_case_types)]
                    struct GetUsageSvc<T: BillingService>(pub Arc<T>);
                    impl<
                        T: BillingService,
                    ...
                    for GetUsageSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as BillingService>::get_usage(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "hahi.billing.BillingService";
