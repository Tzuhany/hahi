...
pub mod conversation_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/hahi.chat.ConversationService/GetConversation",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("hahi.chat.ConversationService", "GetConversation"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/hahi.chat.ConversationService/ListConversations",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("hahi.chat.ConversationService", "ListConversations"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/hahi.chat.ConversationService/DeleteConversation",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "hahi.chat.ConversationService",
                        "DeleteConversation",
                    ),
                );
            self.inner.unary(req, path, codec).await
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/hahi.chat.ConversationService/ListMessages",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("hahi.chat.ConversationService", "ListMessages"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
pub mod conversation_service_server {
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/hahi.chat.ConversationService/GetConversation" => {
                    #[allow(non_camel_case_types)]
                    struct GetConversationSvc<T: ConversationService>(pub Arc<T>);
                    impl<
                        T: ConversationService,
                    ...
                    for GetConversationSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ConversationService>::get_conversation(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/hahi.chat.ConversationService/ListConversations" => {
                    #[allow(non_camel_case_types)]
                    struct ListConversationsSvc<T: ConversationService>(pub Arc<T>);
                    impl<
                        T: ConversationService,
                    ...
                    for ListConversationsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ConversationService>::list_conversations(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/hahi.chat.ConversationService/DeleteConversation" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteConversationSvc<T: ConversationService>(pub Arc<T>);
                    impl<
                        T: ConversationService,
                    ...
                    for DeleteConversationSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ConversationService>::delete_conversation(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/hahi.chat.ConversationService/ListMessages" => {
                    #[allow(non_camel_case_types)]
                    struct ListMessagesSvc<T: ConversationService>(pub Arc<T>);
                    impl<
                        T: ConversationService,
                    ...
                    for ListMessagesSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ConversationService>::list_messages(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "hahi.chat.ConversationService";
